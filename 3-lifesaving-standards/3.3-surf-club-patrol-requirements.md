...
The following gear and equipment items must be deployed or available at a minimum for all SLS patrols.

| Item | Full Patrol | Standby Patrol | Outpost Patrol | Mobile (Vehicle) | Roving (Foot) |
| --- | --- | --- | --- | --- | --- |
...
| Handheld radios in DMR waterproof bags as per the requirements of [SOP 7.2 – Radio Equipment Specifications](../7-communications/7.2-radio-equipment-specifications.md) (number of radios will be relevant to size of patrol) | 4 | 2 | 2 | 1 | 1 |
...
Rescue call out gear is listed in [SOP 12.4 – Surf Club Emergency Response Teams (ERT)](../12-emergency-management-and-response-operations/12.4-surf-club-emergency-response-teams-ert.md).
